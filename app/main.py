...
async def startup_event():
    ...
    # Load rice variety model
    try:
        rice_variety_path = base_dir / "app" / "ml" / "models" / "rice_variety"
        logger.info(f"Loading model from: {rice_variety_path}")
        ...
        logger.info("Rice variety model loaded successfully")
    except ModelLoadError as e:
        logger.error(f"Failed to load rice variety model: {e}")
